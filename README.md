...
Cancel orders with automatic product return to the store
...
Backend:
PHP 8+ with PDO for secure database interaction

Database:
MySQL — storing users, products, and orders
...
Integrate payment methods (PayPal, Kaspi, etc.)
